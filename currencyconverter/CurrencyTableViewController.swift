...
class CurrencyTableViewController: UITableViewController
{
    ...
    let image = [#imageLiteral(resourceName: "united-states") , #imageLiteral(resourceName: "india") , #imageLiteral(resourceName: "European-Union-Flag") , #imageLiteral(resourceName: "canada")]
